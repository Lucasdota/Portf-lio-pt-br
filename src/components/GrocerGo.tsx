    ...
    >
      ...
      >
        ...
        <div className="w-full hidden z-10 h-full xl:flex flex-col items-center justify-center rounded-xl absolute bg-black/70 border dark:border-neutral-850 border-transparent">
          <h3 className="text-slate-50 tracking-wider">GrocerGo</h3>
      ...
      <p className="text-sm px-4 whitespace-normal">
        Um site de supermercado onde o cliente pode fazer login com sua conta
        google ou github, procurar produtos, favoritar, adicionar ao carrinho,
        buscar receitas e muito mais.
      </p>
      {/* GrocerGo accordions */}
      <Accordion />
    </motion.div>
